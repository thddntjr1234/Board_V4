  ...
  <div class="container">
    <form class="form-inline">
      ...
      <div class="input-group-sm">
        ...
        <input name="startDate" class="form-control-sm" type="date" v-model="startDate"/>
        <input name="endDate" class="form-control-sm" type="date" v-model="endDate"/>
        ...
        <input type="search" name="keyword" v-model="keyword">
