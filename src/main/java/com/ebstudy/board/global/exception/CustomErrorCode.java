...
public enum CustomErrorCode {
    ...
    INVALID_USERS_REQUEST(HttpStatus.BAD_REQUEST,40002, "올바른 사용자의 요청이 아닙니다."),
    FAILD_VALIDATION(HttpStatus.BAD_GATEWAY, 40003, ""), // 사용중인 에러 코드라는 것을 알리기 위해 선언

    /**
     * 401 UNAUTHORIZED: 인증되지 않은 사용자의 요청
     */
    UNAUTHORIZED_REQUEST(HttpStatus.UNAUTHORIZED, 40101, "유효하지 않은 사용자의 요청입니다."),

    /**
     * 403 FORBIDDEN: 인증되었으나 권한이 없는 사용자
     */
    DENIED_POST_REQUEST(HttpStatus.FORBIDDEN,40301, "해당 게시글은 작성자만 열람할 수 있습니다."),
